<h1 align="center">Hi 👋, I'm Anagh Krishna Singh</h1>
<h3 align="center">AI & Full-Stack Developer | Electrical Engineering Undergraduate</h3>

<p align="center">
🚀 Building intelligent systems • 🧠 Exploring AI + Web • ⚡ Turning ideas into products
</p>
...
### 🧮 Cruciatus – AI Math Solver
**Tech:** Flask, SQLite, Gemini API, HTML/CSS, JavaScript  
- AI-based handwritten math solver (≤2s response time)
- 99% character recognition accuracy on 200+ samples
- Optimized database storage, reducing redundancy by 40%

---

### 📊 DataLens – AutoML Platform
**Tech:** Flask, scikit-learn, JavaScript  
- Fully automated ML training pipeline for non-technical users
- End-to-end flow: data analysis → feature selection → model evaluation
- Real-time training progress visualization (<1s latency)
